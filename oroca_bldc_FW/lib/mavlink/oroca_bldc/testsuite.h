...
static void mavlink_test_test_cmd(uint8_t system_id, uint8_t component_id, mavlink_message_t *last_msg)
{
	...
	mavlink_status_t *status = mavlink_get_channel_status(MAVLINK_COMM_0);
        if ((status->flags & MAVLINK_STATUS_FLAG_OUT_MAVLINK1) && MAVLINK_MSG_ID_TEST_CMD >= 256) {
        	return;
        }
#endif
	...
	mavlink_test_cmd_t packet1, packet2;
        ...
        if (status->flags & MAVLINK_STATUS_FLAG_OUT_MAVLINK1) {
           ...
           memset(MAVLINK_MSG_ID_TEST_CMD_MIN_LEN + (char *)&packet1, 0, sizeof(packet1)-MAVLINK_MSG_ID_TEST_CMD_MIN_LEN);
        }
#endif
...
static void mavlink_test_test_resp1(uint8_t system_id, uint8_t component_id, mavlink_message_t *last_msg)
{
#ifdef MAVLINK_STATUS_FLAG_OUT_MAVLINK1
	mavlink_status_t *status = mavlink_get_channel_status(MAVLINK_COMM_0);
        if ((status->flags & MAVLINK_STATUS_FLAG_OUT_MAVLINK1) && MAVLINK_MSG_ID_TEST_RESP1 >= 256) {
        	return;
        }
#endif
	mavlink_message_t msg;
	...
	mavlink_test_resp1_t packet1, packet2;
        ...
        if (status->flags & MAVLINK_STATUS_FLAG_OUT_MAVLINK1) {
           // cope with extensions
           memset(MAVLINK_MSG_ID_TEST_RESP1_MIN_LEN + (char *)&packet1, 0, sizeof(packet1)-MAVLINK_MSG_ID_TEST_RESP1_MIN_LEN);
        }
#endif
        memset(&packet2, 0, sizeof(packet2));
...
static void mavlink_test_set_velocity(uint8_t system_id, uint8_t component_id, mavlink_message_t *last_msg)
{
	...
	mavlink_set_velocity_t packet1, packet2;
        memset(&packet1, 0, sizeof(packet1));
        packet1.ang_vel = packet_in.ang_vel;
        packet1.set_Velocity = packet_in.set_Velocity;
	...
	mavlink_msg_set_velocity_decode(&msg, &packet2);
        ...
        memset(&packet2, 0, sizeof(packet2));
	mavlink_msg_set_velocity_pack(system_id, component_id, &msg , packet1.set_Velocity , packet1.ang_vel );
	mavlink_msg_set_velocity_decode(&msg, &packet2);
        MAVLINK_ASSERT(memcmp(&packet1, &packet2, sizeof(packet1)) == 0);

        memset(&packet2, 0, sizeof(packet2));
	mavlink_msg_set_velocity_pack_chan(system_id, component_id, MAVLINK_COMM_0, &msg , packet1.set_Velocity , packet1.ang_vel );
	mavlink_msg_set_velocity_decode(&msg, &packet2);
        MAVLINK_ASSERT(memcmp(&packet1, &packet2, sizeof(packet1)) == 0);
	...
	mavlink_msg_set_velocity_decode(last_msg, &packet2);
        ...
        memset(&packet2, 0, sizeof(packet2));
	mavlink_msg_set_velocity_send(MAVLINK_COMM_1 , packet1.set_Velocity , packet1.ang_vel );
	mavlink_msg_set_velocity_decode(last_msg, &packet2);
        MAVLINK_ASSERT(memcmp(&packet1, &packet2, sizeof(packet1)) == 0);
}
