						       ...
						       uint8_t cmd_1, uint8_t arg1, uint16_t arg2)
{
    ...
    return mavlink_finalize_message(msg, system_id, component_id, MAVLINK_MSG_ID_TEST_CMD_LEN, MAVLINK_MSG_ID_TEST_CMD_CRC);
#else
    return mavlink_finalize_message(msg, system_id, component_id, MAVLINK_MSG_ID_TEST_CMD_LEN);
#endif
}
						           ...
						           uint8_t cmd_1,uint8_t arg1,uint16_t arg2)
{
	...
	msg->msgid = MAVLINK_MSG_ID_TEST_CMD;
#if MAVLINK_CRC_EXTRA
    return mavlink_finalize_message_chan(msg, system_id, component_id, chan, MAVLINK_MSG_ID_TEST_CMD_LEN, MAVLINK_MSG_ID_TEST_CMD_CRC);
#else
    return mavlink_finalize_message_chan(msg, system_id, component_id, chan, MAVLINK_MSG_ID_TEST_CMD_LEN);
#endif
}
...
#if MAVLINK_CRC_EXTRA
    _mav_finalize_message_chan_send(chan, MAVLINK_MSG_ID_TEST_CMD, buf, MAVLINK_MSG_ID_TEST_CMD_LEN, MAVLINK_MSG_ID_TEST_CMD_CRC);
#else
    _mav_finalize_message_chan_send(chan, MAVLINK_MSG_ID_TEST_CMD, buf, MAVLINK_MSG_ID_TEST_CMD_LEN);
#endif
#else
	mavlink_test_cmd_t packet;
	packet.arg2 = arg2;
...
#if MAVLINK_CRC_EXTRA
    _mav_finalize_message_chan_send(chan, MAVLINK_MSG_ID_TEST_CMD, (const char *)&packet, MAVLINK_MSG_ID_TEST_CMD_LEN, MAVLINK_MSG_ID_TEST_CMD_CRC);
#else
    _mav_finalize_message_chan_send(chan, MAVLINK_MSG_ID_TEST_CMD, (const char *)&packet, MAVLINK_MSG_ID_TEST_CMD_LEN);
#endif
#endif
}
...
#else
	memcpy(test_cmd, _MAV_PAYLOAD(msg), MAVLINK_MSG_ID_TEST_CMD_LEN);
#endif
}
