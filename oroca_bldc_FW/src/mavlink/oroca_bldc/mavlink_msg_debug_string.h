...
#define MAVLINK_MSG_ID_DEBUG_STRING_MIN_LEN 250
#define MAVLINK_MSG_ID_0_LEN 250
#define MAVLINK_MSG_ID_0_MIN_LEN 250

#define MAVLINK_MSG_ID_DEBUG_STRING_CRC 50
...
#define MAVLINK_MESSAGE_INFO_DEBUG_STRING { \
    ...
    "DEBUG_STRING", \
    1, \
    {  { "dbg_str", NULL, MAVLINK_TYPE_CHAR, 250, 0, offsetof(mavlink_debug_string_t, dbg_str) }, \
         } \
}
#else
#define MAVLINK_MESSAGE_INFO_DEBUG_STRING { \
                               ...
                               const char *dbg_str)
{
    ...
    _mav_put_char_array(buf, 0, dbg_str, 250);
...
{
    return mavlink_msg_debug_string_pack(system_id, component_id, msg, debug_string->dbg_str);
}
...
{
    return mavlink_msg_debug_string_pack_chan(system_id, component_id, chan, msg, debug_string->dbg_str);
}
...
static inline void mavlink_msg_debug_string_send(mavlink_channel_t chan, const char *dbg_str)
{
#if MAVLINK_NEED_BYTE_SWAP || !MAVLINK_ALIGNED_FIELDS
    char buf[MAVLINK_MSG_ID_DEBUG_STRING_LEN];
...
{
#if MAVLINK_NEED_BYTE_SWAP || !MAVLINK_ALIGNED_FIELDS
    mavlink_msg_debug_string_send(chan, debug_string->dbg_str);
#else
 ...
 */
static inline void mavlink_msg_debug_string_send_buf(mavlink_message_t *msgbuf, mavlink_channel_t chan,  const char *dbg_str)
{
#if MAVLINK_NEED_BYTE_SWAP || !MAVLINK_ALIGNED_FIELDS
...
{
    return _MAV_RETURN_char_array(msg, dbg_str, 250,  0);
}
