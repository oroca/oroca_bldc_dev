...
Generated from: oroca_bldc.xml,common.xml
    ...
    namespace MavLink
{
	...
	/// </summary>
	public enum MAV_LANDED_STATE : ushort
	{
	...
	/// </summary>
	public enum ADSB_ALTITUDE_TYPE : ushort
	{
	...
	/// </summary>
	public enum ADSB_EMITTER_TYPE : ushort
	{
	...
	/// </summary>
	public enum MAV_DO_REPOSITION_FLAGS : ushort
	{
...
namespace MavLink
{
	...
	/// Message For Test 1
	/// </summary>
	public class Msg_test_cmd : MavlinkMessage
    {
        ...
        public override int Serialize(byte[] bytes, ref int offset)
            {
                return MavLinkSerializer.Serialize_TEST_CMD(this, bytes, ref offset);
            }        
	}
	...
	/// Message For Test 1
	/// </summary>
	public class Msg_test_resp1 : MavlinkMessage
    {
        ...
        public override int Serialize(byte[] bytes, ref int offset)
            {
                return MavLinkSerializer.Serialize_TEST_RESP1(this, bytes, ref offset);
            }        
	}
	...
	public class Msg_set_velocity : MavlinkMessage
    {
		...
		/// set cmd 2
		/// </summary>
		public byte set_Velocity;

		/// <summary>
		/// arg 1
		/// </summary>
		public UInt16 ang_vel;
