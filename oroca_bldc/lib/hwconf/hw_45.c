...
void hw_init_gpio(void) {
	...
	palSetPadMode(GPIOA, 7,	PAL_MODE_OUTPUT_PUSHPULL |	PAL_STM32_OSPEED_HIGHEST);
	//palSetPadMode(GPIOG, 8,	PAL_MODE_OUTPUT_PUSHPULL |	PAL_STM32_OSPEED_HIGHEST);//for stm3240G-eval
